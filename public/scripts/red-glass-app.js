...
$(document).ready(function(){
    ...
    //Poll the test status
    $.periodic({period: 2000, max_period: 60000}, function() {
        $.ajax({
            periodic: this,
            url: "/events",
    ...
    $(document).on('click', 'a.js-error-detail', function(event){
        ...
        $(dialogContainer).dialog({
            ...
            open: function(){
                ...
                errorDetail += "Line Number: " + domEvent.error_line_number + "\n";
                errorDetail += "Error Message: " + domEvent.error_message;
